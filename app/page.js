    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between ">
            ...
            <nav className="fixed text-5xl  mt-10 text-red-600 flex mr-[120vh]">
                ...
                <Link target={"_blank"} href="https://birdeye.so/token/EaR4ooS5yJ1DxvRPoyVXTYoTBekDhZimjonJ8V1PZk6L?chain=solana" data-text="Buy" className="left-[120vh]">Buy</Link>
                <Link target={"_blank"} href="https://discord.gg/DwHepbHS" data-text="Discord" >Discrod</Link>
            </nav>
